    ...
    <div className="space-y-8 p-6 lg:p-10">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-rare-primary to-rare-secondary shadow-2xl shadow-rare-primary/20">
        ...
        <div className="relative z-10 p-10 md:p-14 text-white">
          ...
          <p className="font-body text-rare-background/80 text-lg max-w-2xl leading-relaxed">
      ...
      <div>
        <div className="flex items-center justify-between mb-6 px-2">
          <h3 className="font-heading text-2xl font-bold text-rare-primary">Overview</h3>
          <span className="text-sm text-rare-text-light font-body bg-white/50 px-3 py-1 rounded-full border border-rare-primary/10">
            Last 30 Days
          </span>
        </div>
        <EcommerceMetrics />
