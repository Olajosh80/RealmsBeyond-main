            ...
            <main className="flex-grow p-6 lg:p-10">
                <div className="max-w-7xl mx-auto space-y-6">
                    <div className="flex justify-between items-center">
                        <h1 className="font-heading text-3xl font-bold text-white">Product Tags</h1>
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full text-left">
                                        ...
                                        <tbody className="divide-y divide-slate-700/50">
                                            {tags.map(tag => (
                                                <tr key={tag._id} className="group hover:bg-slate-700/30 transition-colors">
                                                    <td className="p-4"><input type="checkbox" className="rounded bg-slate-700 border-slate-600" /></td>
                                                    <td className="p-4">
                                                        <div className="font-bold text-white hover:text-rare-accent cursor-pointer transition-colors">{tag.name}</div>
                                                        <div className="flex gap-2 mt-1 opacity-0 group-hover:opacity-100 transition-opacity text-xs">
                                                            ...
                                                            <span className="text-slate-600">|</span>
                                                            <button onClick={() => handleDelete(tag._id)} className="text-red-400 hover:text-red-300 hover:underline">Delete</button>
                                                            <span className="text-slate-600">|</span>
                                                            <button className="text-slate-400 hover:text-slate-200 hover:underline">View</button>
                                                        </div>
                                                    </td>
                                                    <td className="p-4 text-sm text-slate-400 max-w-xs truncate">{tag.description || '—'}</td>
