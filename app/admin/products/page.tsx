                    ...
                    <div className="bg-white/60 backdrop-blur-md rounded-xl border border-white/40 shadow-sm p-4 flex flex-col md:flex-row gap-4 justify-between items-center">
                        <div className="flex gap-2 w-full md:w-auto">
                            <div className="flex items-center gap-2 text-sm text-rare-text-light">
                                <span className="font-medium text-rare-primary">All ({products.length})</span>
                                <span className="text-gray-300">|</span>
                                <span className="hover:text-rare-primary cursor-pointer">Published ({products.filter(p => p.in_stock).length})</span>
                                <span className="text-gray-300">|</span>
                                <span className="hover:text-rare-primary cursor-pointer">Drafts (0)</span>
                            </div>
                        </div>
                                                    ...
                                                    <tr className="group hover:bg-white/40 transition-colors">
                                                        ...
                                                        <td className="p-4">
                                                            ...
                                                            <div className="flex items-center gap-3 mt-1 text-xs opacity-0 group-hover:opacity-100 transition-opacity">
                                                                ...
                                                                <span className="text-gray-300">|</span>
                                                                <Link href={`/product/${product.slug}`} target="_blank" className="text-gray-500 hover:text-gray-800 hover:underline">View</Link>
                                                            </div>
                                                        </td>
                                                        <td className="p-4">
                                                            {product.in_stock ? (
